...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_pedidos`.`representante` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_pedidos`.`cliente` (
  ...
  CONSTRAINT `fk_cliente`
    ...
    REFERENCES `db_pedidos`.`representante` (`cd_representante`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_pedidos`.`produto` (
...
CREATE TABLE IF NOT EXISTS `db_pedidos`.`estoque` (
  ...
  CONSTRAINT `fk_estoque1`
    ...
    REFERENCES `db_pedidos`.`produto` (`cd_produto`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_pedidos`.`pedido` (
  ...
  CONSTRAINT `fk_pedido1`
    ...
    REFERENCES `db_pedidos`.`cliente` (`cd_cliente`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_pedidos`.`pedido_produto` (
  ...
  CONSTRAINT `fk_pedido_produto1`
    ...
    REFERENCES `db_pedidos`.`pedido` (`nr_pedido`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
